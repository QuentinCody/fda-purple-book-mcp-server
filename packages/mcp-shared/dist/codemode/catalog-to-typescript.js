...
function formatParamList(endpoint) {
    const parts = [];
    const required = [];
    const optional = [];
 ...
 */
export function catalogToTypeScript(catalog, options) {
...
function formatSpecOpParams(allParams, hasBody) {
    const required = [];
    const optional = [];
...
function selectSpecOperations(ops, maxEndpoints) {
...
function renderSpecSummary(title, ops, selected) {
    const groups = new Map();
 ...
 */
export function specToTypeScript(spec, options) {
...
//# sourceMappingURL=catalog-to-typescript.js.map