...
import { buildPrefixHeader, COMMON_PREFIXES, probeSparqlEndpoint, } from "./sparql-introspection";
...
export function createSparqlExecuteTool(options) {
    ...
    return {
        ...
        schema: {
            code: z
                .string()
                .describe("JavaScript code to execute. Use sparql.query() for SELECT/CONSTRUCT/DESCRIBE and sparql.ask() for ASK. " +
