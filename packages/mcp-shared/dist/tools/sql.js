...
export const sqlTools = [
    {
        ...
        schema: {
            query: z
                .string()
                .describe("SQL SELECT query to execute. Only SELECT, PRAGMA, and EXPLAIN statements are allowed."),
            params: z
                .array(sqlParam)
                .optional()
    ...
    },
    {
        ...
        schema: {
            query: z
                .string()
                .describe("SQL DDL/DML statement to execute (CREATE TABLE, INSERT, UPDATE, DELETE, etc). ATTACH, DETACH, and LOAD_EXTENSION are blocked."),
            params: z
                .array(sqlParam)
                .optional()
                .describe("Optional query parameters for parameterized queries"),
    ...
    },
    {
        ...
        handler: async (input, ctx) => {
            ...
            for (let i = 0; i < statements.length; i++) {
                ...
                if (isBlocked(query)) {
                    results.push({
                        index: i,
                        success: false,
                        error: "ATTACH, DETACH, and LOAD_EXTENSION statements are not allowed.",
                    });
                    continue;
                }
                try {
            ...
            return {
                ...
                succeeded: statements.length - failed,
                failed,
                results,
            };
        },
