...
export async function ols4Search(query, opts = {}) {
    const { fetchImpl = fetch, timeoutMs = 15_000, userAgent = "bio-mcp-ols4/1.0", ontology = "efo", rows = 25, exact = false, } = opts;
    ...
    try {
        ...
        if (!resp.ok)
            throw new Error(`OLS4 HTTP ${resp.status}`);
...
export async function ols4TermDescendants(ontology, iri, opts = {}) {
...
//# sourceMappingURL=efo_ols4.js.map