...
export async function clinvarEsummary(ids, opts = {}) {
    ...
    try {
        ...
        if (!resp.ok)
            throw new Error(`ClinVar HTTP ${resp.status}`);
...
export async function clinvarEsearchByRsid(rsid, opts = {}) {
    const { fetchImpl = fetch, timeoutMs = 15_000, userAgent = "bio-mcp-clinvar/1.0", apiKey, } = opts;
...
//# sourceMappingURL=clinvar.js.map