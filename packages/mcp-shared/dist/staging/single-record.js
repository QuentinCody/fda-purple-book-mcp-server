...
function hasMultiRowCollection(obj) {
...
export function isSingleRecordResponse(data) {
    if (Array.isArray(data))
        return data.length <= 1;
    if (!data || typeof data !== "object")
        return true;
    const obj = data;
    if (hasMultiRowCollection(obj))
        return false;
 ...
 */
export function effectiveStagingThreshold(data, baseThreshold) {
...
//# sourceMappingURL=single-record.js.map