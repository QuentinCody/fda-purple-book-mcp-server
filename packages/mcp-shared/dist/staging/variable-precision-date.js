 ...
 */
export function parseVariablePrecisionDate(input) {
    ...
    if (pubmed) {
        ...
        if (monthName) {
            const monthCode = PUBMED_MONTH_NAMES[monthName
                .toLowerCase()
                .slice(0, 4)
                .replace(/[^a-z]/g, "")] ?? PUBMED_MONTH_NAMES[monthName.toLowerCase().slice(0, 3)];
            if (monthCode) {
                if (day) {
 ...
 */
export function variablePrecisionColumnNames(field) {
    return {
        iso: `${field}_iso`,
 ...
 */
export function enrichWithVariablePrecisionDate(obj, field) {
...
//# sourceMappingURL=variable-precision-date.js.map