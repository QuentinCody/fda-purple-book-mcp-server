 ...
 */
export declare function storeRawPayload(sql: SqlExec, chunking: Pick<ChunkingEngine, "smartJsonStringify">, data: unknown, fallbackReason?: string): Promise<RawPayloadResult>;
