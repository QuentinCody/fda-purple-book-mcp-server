...
export function buildToolCall(tool, params, id) {
    return {
        jsonrpc: "2.0",
        id,
        method: "tools/call",
...
export function parseToolResult(resp) {
    ...
    if (!result)
        throw new Error("monitor in-fabric call: missing result");
    if (result.isError) {
